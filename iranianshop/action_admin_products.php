...
<?php
	...
	{
		echo "پرونده ای با همین نام در سرویس دهنده وجود دارد <br/>";
		$uploadOk=0;
	}
	
	if($_FILES["pro_image"]["size"]>(500*1024))
	{
		echo "اندازه پرونده انتخابی بیش از 500 کیلوبایت است <br/>";
		$uploadOk=0;
	}
	...
	else
	{
		if(move_uploaded_file($_FILES["pro_image"]["tmp_name"],$target_file))
		{
			echo "پرونده".$_FILES["pro_image"]["name"].
				"با موفقیت به سرویس دهنده میزبان انتقال یاقت <br/>";
		}
		else
		{
